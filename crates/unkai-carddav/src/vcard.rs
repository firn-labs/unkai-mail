...
/// `unkai_core::models::StructuredName` so the carddav crate can
...
/// One vCard `ADR` property. Mirrors `unkai_core::models::ContactAddress`
...
/// from `TYPE=`. Mirrors `unkai_core::models::ContactPhone`; same
